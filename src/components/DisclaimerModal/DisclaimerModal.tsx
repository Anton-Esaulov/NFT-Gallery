    ...
    if (step === 'disclaimer') {
      return (
        <div>
          <p>Audits: None.</p>
          <p>
            While the initial creators of the NFTG protocol have made
      ...
      return (
        <div>
          <p>Attention NFTG Uniswap LPs</p>
          <p>
            The only Uniswap pool that is compatible with NFTG is NFTG/yCRV
            (Curve yPool tokens)
          </p>
